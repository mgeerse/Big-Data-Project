...
if(INSTALL_PACKAGES)
{
  install.packages("RTools",repos="https://cran.hafro.is/")
  install.packages("foreign",repos="https://cran.hafro.is/")
  install.packages("class",repos="https://cran.hafro.is/")
  ...
  install.packages("gmodels",repos="https://cran.hafro.is/")
  install.packages('MASS',repos="https://cran.hafro.is/")
  install.packages('ISLR',repos="https://cran.hafro.is/")
  install.packages('GeNetIt',repos="https://cran.hafro.is/")
} else {
...
BigTommat<-system1[system1$plant>=300&system1$plant<=311,]
PrunaxxTomaat<-system1[system1$plant>=500&system1$plant<=511,]
SmallTomaat<-system2[system2$plant>=600&system2$plant<=611,]

BigTommat$averageWeight<-ifelse(BigTommat$freshweight<mean(BigTommat$freshweight),0,1)
BigTommat$averageWeight<-as.factor(BigTommat$averageWeight)
levels(BigTommat$averageWeight)<-c("Low yield", "high yield")
...
borutaBigTomaat<-trainBorutaModel(BigTommat)

...
result<-knn(test = na.omit(testData), train = na.omit(trainData), k = 10, cl = na.omit(train_labels))
...
result<-knn(test = testData, train = trainData, k = 8, cl = train_labels)
...
result<-knn(test = testData, train = trainData, k = 10, cl = train_labels)
